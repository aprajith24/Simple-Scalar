...
{ 
  ...
  if (!(struct cache_blk_t *)blk->way_prev && !(struct cache_blk_t *)blk->way_next)
    {
  ...
  /* else, more than one element in the list */
  else if (!(struct cache_blk_t *)blk->way_prev)
    {
      assert(set->way_head == blk && set->way_tail != blk);
      if (where == Head)
	{
     ...
     /* else, move to tail */
      set->way_head = (struct cache_blk_t *)blk->way_next;
      ((struct cache_blk_t *)blk->way_next)->way_prev = NULL;
    }
      ...
      if (where == Tail)
	{
      ...
      set->way_tail = (struct cache_blk_t *)blk->way_prev;
      ((struct cache_blk_t *)blk->way_prev)->way_next = NULL;
    }
  else
    {
      /* middle of list (and not front or end of list) */
      assert(set->way_head != blk && set->way_tail != blk);
      ((struct cache_blk_t *)blk->way_prev)->way_next = (struct cache_blk_t *)blk->way_next;
      ((struct cache_blk_t *)blk->way_next)->way_prev = (struct cache_blk_t *)blk->way_prev;
    }
